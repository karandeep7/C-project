<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FacultyDesig.aspx.cs" Inherits="WebApplication5.FacultyDesig" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-color: #66029F; color: #FFFFFF; width: 100%; height: inherit;">
        <br /><br /><br /><br /><br /><br />
        <center>
            <h1> Faculty Designation Entry Form </h1> 
        ...
        <div class="floating" style="padding-left: 100px; width: 60%;">
            ...
            <asp:Label ID="Label2" runat="server" Text="Designation ID"></asp:Label>
